...
public class choiceLooping {
	...
	public static void main(String[] args)
	{
		...
		double tamaleOrdered = 0;
		double burritoOrdered = 0;
		double nachoOrdered = 0;
		double enchiladaOrdered = 0 ;
		double chickenAndCornChilaquileOrdered = 0;
		double fajitaOrdered = 0;
		double burritoBowlSoupOrdered = 0;
		double cheesyBeefQuesadillaOrdered = 0;
		double totalPrice;
		double orderNumber;
		...
		while(response <= 10)
			...
			System.out.print("Type a number greater than 10 to quit");
					response = inputDevice.nextInt();
			}
			totalPrice = (popOrdered * popPrice) + (tacoOrdered * tacoPrice) + (tamaleOrdered * tamalesPrice) + (burritoOrdered * burritoPrice) + 
		    (nachoOrdered * nachoPrice) + (enchiladaOrdered * EnchiladaPrice) + (chickenAndCornChilaquileOrdered * ChickenAndCornChilaquilesPrice) + 
		    (burritoBowlSoupOrdered * BurritoBowlSoupEnchiladaPrice) +  (cheesyBeefQuesadillaOrdered * CheesyBeefQuesadillaPrice);
